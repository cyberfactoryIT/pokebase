...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-2"><strong>{{ __('messages.Responsible') }}:</strong> {{ $project->responsible?->name }} ({{ $project->responsible?->email }})</div>
    ...
    <div class="mb-2"><strong>{{ __('messages.Dates') }}:</strong> {{ $project->starts_at?->format('Y-m-d') }} — {{ $project->ends_at?->format('Y-m-d') }}</div>
