...
<head>
    ...
    <title>404 - {{ __('errors.page_not_found') }} | Basecard</title>
...
<body class="bg-black text-white min-h-screen flex items-center justify-center">
    <div class="max-w-2xl mx-auto px-6 text-center">
        ...
        <!-- Error Code -->
        <div class="mb-6">
            <h1 class="text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">
                404
            </h1>
        </div>
